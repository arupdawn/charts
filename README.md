...
## How to run the App
Simply go to the directory name charts on your local machine.
#### `cd charts`

In the project directory, you need to first install npm.
#### `npm install`

Once npm is installed, please run the below command to start the application
#### `npm start`
